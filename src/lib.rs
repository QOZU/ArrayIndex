...
#[derive(Debug)]
pub struct ArrayIndexProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ArrayIndexProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ArrayIndex processing");
    
    let mut processor = ArrayIndexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ArrayIndexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ArrayIndexProcessor::new(false);
